<?php
/**
 * TechToday functions and definitions
 *
 ...
 */
function techtoday_website_theme_setup() {
	/*
 ...
 */
function techtoday_website_theme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'techtoday_website_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'techtoday_website_theme_content_width', 0 );
